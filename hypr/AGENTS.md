...
- Local copies of the source code are located at:
  - `~/Local/docs/hyprland-wiki`
  - `~/Local/docs/Hyprland`
  - If these are not present, please `mkdir -p ~/Local/docs` and attempt to clone them to this folder via `git clone https://github.com/hyprwm/hyprland-wiki.git` & `git clone https://github.com/hyprwm/Hyprland.git`. This should be attempted before ever considering retrieval of canonical information via any web search/exploration.
