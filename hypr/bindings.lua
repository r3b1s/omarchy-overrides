...
exec("SUPER + CTRL + H", delta .. " -x", "Expand window horizontal")
unbindAll({
  "SUPER + CTRL + L",
  "SUPER + CTRL + " .. key.l,
})
exec("SUPER + CTRL + L", delta .. " x", "Shrink window horizontal")
unbindAll({
  "SUPER + CTRL + K",
  "SUPER + CTRL + " .. key.k,
})
exec("SUPER + CTRL + K", delta .. " y", "Expand window vertical")
unbindAll({
  "SUPER + CTRL + J",
  "SUPER + CTRL + " .. key.j,
})
exec("SUPER + CTRL + J", delta .. " -y", "Shrink window vertical")
...
-- Brightness.
unbind(brightUp)
exec(brightUp, "omarchy-brightness-display +5%", "Brightness Up")
unbind(brightDown)
exec(brightDown, "omarchy-brightness-display 5%-", "Brightness Down")

-- Fine tune brightness.
unbind("ALT + " .. brightUp)
exec("ALT + " .. brightUp, "omarchy-brightness-display +1%", "Fine Brightness Up")
unbind("ALT + " .. brightDown)
exec("ALT + " .. brightDown, "omarchy-brightness-display 1%-", "Fine Brightness Down")
...
exec("SUPER + CTRL + N", bin .. "/my-toggle-nightlight", "Toggle Nightlight")
...
exec("SUPER + SHIFT + Equal", bin .. "/hyprland-monitor-scale in", "Display Scale - Increase")
unbindAll({
  "SUPER + SHIFT + minus",
  "SUPER + SHIFT + Minus",
  "SUPER + SHIFT + MINUS",
...
exec("SUPER + SHIFT + Minus", bin .. "/hyprland-monitor-scale out", "Display Scale - Decrease")
...
exec("SUPER + SHIFT + Backspace", bin .. "/hyprland-window-gaps-cycle", "Cycle Window Gap Size")
unbindAll({
...
exec("SUPER + CTRL + Backspace", bin .. "/hyprland-window-borders-cycle", "Cycle Window Border Thickness")
unbindAll({
  "SUPER + ALT + backspace",
  "SUPER + ALT + Backspace",
  "SUPER + ALT + BACKSPACE",
...
exec("SUPER + ALT + Backspace", bin .. "/hyprland-workspace-layout", "Cycle active workspace layout")
unbindAll({
...
exec("SUPER + SHIFT + CTRL + ALT + Backspace", bin .. "/hyprland-window-round-toggle", "Toggle Window Rounding")
...
exec("SUPER + ALT + Semicolon", "omarchy-menu screenrecord", "Screen Record")
unbindAll({
  "SUPER + R",
  "SUPER + " .. key.r,
})
exec("SUPER + R", "omarchy-cmd-screenrecord --with-desktop-audio --with-microphone-audio", "Screen Record")
...
exec("SUPER + SHIFT + R", "omarchy-cmd-screenrecord --stop-recording", "Stop Screen Recording")
...
exec("SUPER + CTRL + R", bin .. "/gifrecord", "Screen Record GIF")
...
exec("SUPER + Return", 'walker -p "Start…"', "Launch apps")
...
exec("SUPER + SHIFT + B", uwsmLaunch .. " firefox -p Personal", "Firefox - Personal")
unbindAll({
  "SUPER + CTRL + B",
  "SUPER + CTRL + " .. key.b,
})
exec("SUPER + CTRL + B", uwsmLaunch .. " qutebrowser --target window", "Qutebrowser")
...
exec("SUPER + X", "makoctl dismiss", "Dismiss last notification")
unbindAll({
  "SUPER + SHIFT + X",
  "SUPER + SHIFT + " .. key.x,
})
exec("SUPER + SHIFT + X", "makoctl dismiss --all", "Dismiss all notifications")
unbindAll({
  "SUPER + CTRL + X",
  "SUPER + CTRL + " .. key.x,
})
...
exec("SUPER + SHIFT + CTRL + ALT + W", "pkill waybar; waybar &", "Reload Waybar")
...
exec("SUPER + SHIFT + CTRL + ALT + G", bin .. "/hyprland-toggle-i3-mode", "Toggle i3 mode")
...
scratchpad("SUPER + CTRL + W", "Networks-&-WiFi", "exec omarchy-launch-wifi")
...
scratchpad("SUPER + ALT + W", "Bluetooth", "omarchy-launch-bluetooth")
...
scratchpad(
  "SUPER + " .. key.o,
  "Obsidian",
  uwsmLaunch .. " $HOME/Applications/Obsidian-1.12.7.AppImage",
...
scratchpad("SUPER + CTRL + M", "Moonlight", uwsmLaunch .. " com.moonlight_stream.Moonlight")
...
scratchpad("SUPER + SHIFT + CTRL + P", "Cryptomator", uwsmLaunch .. " org.cryptomator.Cryptomator", {
  layout = "master",
  layout_opts = { orientation = "center" },
})
...
exec("SHIFT + CTRL + ALT + " .. key.z, [[notify-send "Moonlight Focus Toggled"]], "Notify Moonlight Focus Toggled")
...
exec("SUPER + Q", uwsmLaunch .. ' "$HOME/.cargo/bin/inputbox"', "Inputbox")
