...
$DOTS/scripts/import-backgrounds.sh remove # Remove imported backgrounds
mv -v $OMARCHY_BIN/omarchy-theme-sync /tmp/omarchy-theme-sync # Move omarchy-theme-sync bin to tmp

# Sever Symbolic Links
$DOTS/scripts/link-webapp-firefox.sh sever # Sever link to omarchy-launch-webapp + restore backup
$DOTS/scripts/link-configs.sh sever # Sever links to core configs + restore backups
